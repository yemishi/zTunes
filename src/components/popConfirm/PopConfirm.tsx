...
export default function PopupDelete({ onClose, confirm, name, isLoading }: PropsType) {
  return (
    <Modal
      onClose={onClose}
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <p className="text-sm lg:text-base text-red-500 font-medium">This action is permanent and cannot be undone.</p>
      </div>
